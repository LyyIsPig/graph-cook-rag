...
class GraphIndexingModule:
    ...
    def _llm_enhance_relation_keys(self, source_entity: EntityKeyValue, 
        ...
        """
        prompt = f"""
为以下实体关系生成主题关键词，只输出JSON。
源: {source_entity.entity_name} ({source_entity.entity_type})
目标: {target_entity.entity_name} ({target_entity.entity_type})
关系: {relation_type}
输出: {{"keywords": ["关键词1", "关键词2", "关键词3"]}}
"""
